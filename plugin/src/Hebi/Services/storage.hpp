...
class Storage : public TickingService {
    ...
    Q_PROPERTY(QQmlListProperty<hebi::services::DiskInfo> disks READ disksProp NOTIFY disksChanged)
    Q_PROPERTY(hebi::services::DiskInfo* manualPrimaryDisk READ manualPrimaryDisk WRITE setManualPrimaryDisk NOTIFY
            manualPrimaryDiskChanged)
    Q_PROPERTY(hebi::services::DiskInfo* primaryDisk READ primaryDisk NOTIFY primaryDiskChanged)
