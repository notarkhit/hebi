...
class Lyrics : public QObject {
    ...
    Q_PROPERTY(hebi::services::LyricsBackend::Backend backend READ backend NOTIFY backendChanged)
    Q_PROPERTY(hebi::services::LyricsBackend::Backend preferredBackend READ preferredBackend WRITE
            setPreferredBackend NOTIFY preferredBackendChanged)
    Q_PROPERTY(
        QList<hebi::services::LyricCandidate> lyricCandidates READ lyricCandidates NOTIFY lyricCandidatesChanged)
    Q_PROPERTY(hebi::services::LyricCandidate selectedCandidate READ selectedCandidate WRITE setSelectedCandidate
