...
class Config : public QQuickAttachedPropertyPropagator, public QQmlParserStatus {
    ...
    Q_PROPERTY(const hebi::config::AppearanceConfig* appearance READ appearance NOTIFY sourceChanged)
    Q_PROPERTY(const hebi::config::GeneralConfig* general READ general NOTIFY sourceChanged)
    Q_PROPERTY(const hebi::config::BackgroundConfig* background READ background NOTIFY sourceChanged)
    Q_PROPERTY(const hebi::config::BarConfig* bar READ bar NOTIFY sourceChanged)
    Q_PROPERTY(const hebi::config::BorderConfig* border READ border NOTIFY sourceChanged)
    Q_PROPERTY(const hebi::config::DashboardConfig* dashboard READ dashboard NOTIFY sourceChanged)
    Q_PROPERTY(const hebi::config::LauncherConfig* launcher READ launcher NOTIFY sourceChanged)
    Q_PROPERTY(const hebi::config::LockConfig* lock READ lock NOTIFY sourceChanged)
    Q_PROPERTY(const hebi::config::NexusConfig* nexus READ nexus NOTIFY sourceChanged)
    Q_PROPERTY(const hebi::config::NotifsConfig* notifs READ notifs NOTIFY sourceChanged)
    Q_PROPERTY(const hebi::config::OsdConfig* osd READ osd NOTIFY sourceChanged)
    Q_PROPERTY(const hebi::config::ServiceConfig* services READ services NOTIFY sourceChanged)
    Q_PROPERTY(const hebi::config::SessionConfig* session READ session NOTIFY sourceChanged)
    Q_PROPERTY(const hebi::config::SidebarConfig* sidebar READ sidebar NOTIFY sourceChanged)
    Q_PROPERTY(const hebi::config::UtilitiesConfig* utilities READ utilities NOTIFY sourceChanged)
    Q_PROPERTY(const hebi::config::WInfoConfig* winfo READ winfo NOTIFY sourceChanged)
    Q_PROPERTY(const hebi::config::UserPaths* paths READ paths NOTIFY sourceChanged)
