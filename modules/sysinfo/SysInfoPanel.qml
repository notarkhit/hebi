...
PanelWindow {
    ...
    Item {
        ...
        BlobRect {
            ...
            Behavior on x {
                NumberAnimation { duration: 320; easing.type: root.panelVisible ? Easing.OutQuint : Easing.InCubic }
            }
            Behavior on y {
                NumberAnimation { duration: 320; easing.type: root.panelVisible ? Easing.OutQuint : Easing.InCubic }
            }
            ...
            Behavior on opacity {
                NumberAnimation { duration: root.panelVisible ? 80 : 280 }
            }
        }
    ...
    component InfoRow: Item {
        ...
        RowLayout {
            ...
            Item {
                visible: fillPct >= 0
                implicitWidth: 44; implicitHeight: 4
                Layout.alignment: Qt.AlignVCenter
