...
Item {
    ...
    Rectangle {
        ...
        radius: height / 2
        layer.enabled: true
        color: root.active ? Bar.Palette.blue : root.occupied ? Bar.Palette.surface1 : "transparent"
        ...
        Text {
            ...
            color: root.active ? Bar.Palette.base : root.occupied ? Bar.Palette.text : Bar.Palette.overlay0
