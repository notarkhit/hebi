...
ListView {
    ...
    delegate: Item {
        ...
        RowLayout {
            ...
            Text { text: delRoot.modelData.e; color: Theme.text; font.family: "JetBrainsMono Nerd Font"; font.pixelSize: 24; Layout.alignment: Qt.AlignVCenter }
            Text { text: delRoot.modelData.n; color: (nfList.currentIndex === delRoot.index || hoverHandler.hovered) ? Theme.accent : Theme.text; font.family: "JetBrainsMono Nerd Font"; font.pixelSize: 13; elide: Text.ElideRight; Layout.fillWidth: true; Layout.alignment: Qt.AlignVCenter }
        }
    }
}
